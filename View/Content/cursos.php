                ...
                <div class="col-md-12">
                    ...
                    <div class="filters text-center">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="#" data-filter=".curso-1">Fundamentos de Seguridad Informática en Redes
                                    Sociales</a></li>
                            <li><a href="#" data-filter=".curso-2">Gestión de Riesgos y Protección de la Identidad
                                    Digital</a></li>
                            <li><a href="#" data-filter=".curso-3">Administración del Tiempo y Uso Responsable de Redes
                                    Sociales</a></li>
                            <li><a href="#" data-filter=".curso-4">Consecuencias legales del mal uso de redes
                                    sociales</a></li>
                        </ul>
                    </div>
                    <!-- isotope filters end -->
                    ...
                    <div class="isotope-container row grid-space-20">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-2-label">Importancia de la seguridad en
                                                redes sociales</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-1">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-3">Importancia de la seguridad en redes sociales</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-1">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-4">Medidas de seguridad adicionales en redes sociales</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-1">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-5">Reporte de incidentes de seguridad informática en redes
                                    sociales</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <!-- CURSO 2 - TEMA 1-->
                        <div class="col-sm-6 col-md-3 isotope-item curso-2">
                            <div class="image-box">
                                <div class="overlay-container">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-6">Evaluación y gestión de riesgos en redes sociales</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-2">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-7">Protección de la identidad digital y gestión de la
                                    reputación en línea</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-2">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-9">Prevención y respuesta al ciberacoso</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-2">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-10">Promoción de un entorno en línea seguro</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <!-- CURSO 3 - TEMA 1-->
                        <div class="col-sm-6 col-md-3 isotope-item curso-3">
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="/Sistema_web_seguridad/images/portfolio-7.jpg" alt="">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-11">Gestión del tiempo en el uso de redes sociales</a>
                            </div>
                            <!-- Modal -->
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-3">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-13">Medidas adicionales de seguridad en redes sociales</a>
                            </div>
                            <!-- Modal -->
                            <div class="modal fade" id="project-13" tabindex="-1" role="dialog"
                                aria-labelledby="project-13-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-13-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-3">
                            ...
                            <div class="modal fade" id="project-14" tabindex="-1" role="dialog"
                                aria-labelledby="project-14-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-14-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-3">
                            ...
                            <div class="modal fade" id="project-15" tabindex="-1" role="dialog"
                                aria-labelledby="project-15-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-15-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <!-- CURSO 4 - TEMA 1-->
                        <div class="col-sm-6 col-md-3 isotope-item curso-4">
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="/Sistema_web_seguridad/images/portfolio-7.jpg" alt="">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-16">Consecuencias legales del mal uso de redes sociales</a>
                            </div>
                            <!-- Modal -->
                            <div class="modal fade" id="project-16" tabindex="-1" role="dialog"
                                aria-labelledby="project-16-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-16-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-4">
                            ...
                            <div class="modal fade" id="project-17" tabindex="-1" role="dialog"
                                aria-labelledby="project-17-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-17-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-4">
                            ...
                            <div class="modal fade" id="project-18" tabindex="-1" role="dialog"
                                aria-labelledby="project-18-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-18-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-4">
                            <div class="image-box">
                                ...
                                <a class="btn btn-default btn-block" data-toggle="modal"
                                    data-target="#project-19">Responsabilidad digital y ciudadanía en línea</a>
                            </div>
                            <!-- Modal -->
                            <div class="modal fade" id="project-19" tabindex="-1" role="dialog"
                                aria-labelledby="project-19-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-19-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
                        ...
                        <div class="col-sm-6 col-md-3 isotope-item curso-4">
                            <div class="image-box">
                                <div class="overlay-container">
                                    <img src="/Sistema_web_seguridad/images/portfolio-7.jpg" alt="">
                                    <a class="overlay" data-toggle="modal" data-target="#project-20">
                                        <i class="fa fa-search-plus"></i>
                                        <span>Site Building</span>
                                    </a>
                                </div>
                            ...
                            <div class="modal fade" id="project-20" tabindex="-1" role="dialog"
                                aria-labelledby="project-20-label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span
                                                    aria-hidden="true">&times;</span><span
                                                    class="sr-only">Close</span></button>
                                            <h4 class="modal-title" id="project-20-label">Project Title</h4>
                                        </div>
                                        <div class="modal-body">
